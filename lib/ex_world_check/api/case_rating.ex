...
defmodule ExWorldCheck.Api.CaseRating do
  @moduledoc """
  ...
  - `{:ok, ExWorldCheck.Model.CaseRatingResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec retrieve_case_rating(Tesla.Env.client(), String.t(), String.t(), String.t(), keyword()) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.CaseRatingResponse.t()}
  ...
  def retrieve_case_rating(connection, authorization, date, case_system_id, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, ExWorldCheck.Model.CaseRatingResponse},
  ...
  @spec save_case_rating(
          ...
          integer(),
          String.t(),
          ExWorldCheck.Model.CaseRatingRequest.t(),
          keyword()
        ) :: {:ok, nil} | {:ok, [ExWorldCheck.Model.Error.t()]} | {:error, Tesla.Env.t()}
  def save_case_rating(
        connection,
        authorization,
        date,
        content_type,
