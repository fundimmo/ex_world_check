...
defmodule ExWorldCheck.Api.Case do
  @moduledoc """
  ...
  """
  @spec archive_case(Tesla.Env.client(), String.t(), String.t(), String.t(), keyword()) ::
          {:ok, nil} | {:ok, [ExWorldCheck.Model.Error.t()]} | {:error, Tesla.Env.t()}
  ...
  - `{:ok, ExWorldCheck.Model.CaseBulkResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec archive_cases(
          Tesla.Env.client(),
          ...
          String.t(),
          integer(),
          ExWorldCheck.Model.CaseBulkArchiveRequest.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.CaseBulkResponse.t()}
  ...
  def archive_cases(
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, ExWorldCheck.Model.CaseBulkResponse},
      {400, ExWorldCheck.Model.Error},
      {401, false},
      {404, ExWorldCheck.Model.Error},
      {415, false},
  ...
  @spec assign_cases(
          ...
          String.t(),
          integer(),
          ExWorldCheck.Model.CaseBulkAssignRequest.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.CaseBulkResponse.t()}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec check_case_identifier_availability(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec delete_case(Tesla.Env.client(), String.t(), String.t(), String.t(), keyword()) ::
          {:ok, nil} | {:ok, [ExWorldCheck.Model.Error.t()]} | {:error, Tesla.Env.t()}
  ...
  @spec delete_cases(
          ...
          String.t(),
          integer(),
          ExWorldCheck.Model.CaseBulkDeleteRequest.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.CaseBulkResponse.t()}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec disable_ongoing_screening(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  - `{:ok, ExWorldCheck.Model.Case.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_case(Tesla.Env.client(), String.t(), String.t(), String.t(), keyword()) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.Case.t()}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  ...
  - `{:ok, ExWorldCheck.Model.AuditSearchResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_case_audit_events_by_case_system_id(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.AuditSearchResponse.t()}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def get_case_audit_events_by_case_system_id(
        connection,
        authorization,
        date,
        content_type,
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, ExWorldCheck.Model.AuditSearchResponse},
      {400, ExWorldCheck.Model.Error},
      {401, false},
      {404, ExWorldCheck.Model.Error},
      {415, false},
  ...
  - `{:ok, ExWorldCheck.Model.CaseReference.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_case_reference(Tesla.Env.client(), String.t(), String.t(), String.t(), keyword()) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.CaseReference.t()}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def get_case_reference(connection, authorization, date, case_id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, ExWorldCheck.Model.CaseReference},
      {400, ExWorldCheck.Model.Error},
      {401, false},
      {404, ExWorldCheck.Model.Error},
      {415, false},
  ...
  - `{:ok, ExWorldCheck.Model.OngoingScreeningUpdateSearchResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_ongoing_screening_updates(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          integer(),
          ExWorldCheck.Model.Filter.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.OngoingScreeningUpdateSearchResponse.t()}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def get_ongoing_screening_updates(
        connection,
        authorization,
        date,
        content_type,
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, ExWorldCheck.Model.OngoingScreeningUpdateSearchResponse},
      {400, ExWorldCheck.Model.Error},
      {401, false},
      {404, ExWorldCheck.Model.Error},
      {415, false},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_results(Tesla.Env.client(), String.t(), String.t(), String.t(), keyword()) ::
          {:ok, nil}
          | {:ok, [ExWorldCheck.Model.Result.t()]}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  ...
  @spec link_cases(
          ...
          String.t(),
          integer(),
          ExWorldCheck.Model.CaseBulkLinkRequestCollection.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.CaseBulkResponse.t()}
  ...
  def link_cases(
        ...
        content_type,
        content_length,
        case_bulk_link_request_collection,
        _opts \\ []
      ) do
    request =
      %{}
  ...
  - `{:ok, ExWorldCheck.Model.ScreeningResultCollection.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec partial_update_case(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          integer(),
          String.t(),
          ExWorldCheck.Model.UpdateCase.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.ScreeningResultCollection.t()}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def partial_update_case(
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, ExWorldCheck.Model.ScreeningResultCollection},
      {400, ExWorldCheck.Model.Error},
      {401, false},
      {403, ExWorldCheck.Model.Error},
      {404, ExWorldCheck.Model.Error},
      {415, false},
      {429, false},
      {500, ExWorldCheck.Model.Error}
  ...
  @spec resolve_results(
          ...
          integer(),
          String.t(),
          ExWorldCheck.Model.ResultsResolutionAction.t(),
          keyword()
        ) :: {:ok, nil} | {:ok, [ExWorldCheck.Model.Error.t()]} | {:error, Tesla.Env.t()}
  def resolve_results(
        connection,
  ...
  - `{:ok, ExWorldCheck.Model.CaseSearchResultResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec retrieve_case_summaries(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          integer(),
          ExWorldCheck.Model.CaseSummaryFilter.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.CaseSearchResultResponse.t()}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def retrieve_case_summaries(
        connection,
        authorization,
        date,
        content_type,
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, ExWorldCheck.Model.CaseSearchResultResponse},
      {400, ExWorldCheck.Model.Error},
      {401, false},
      {404, ExWorldCheck.Model.Error},
      {415, false},
  ...
  @spec review_results(
          ...
          integer(),
          String.t(),
          ExWorldCheck.Model.ResultsReview.t(),
          keyword()
        ) :: {:ok, nil} | {:ok, [ExWorldCheck.Model.Error.t()]} | {:error, Tesla.Env.t()}
  def review_results(
        connection,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec save_and_screen_cases(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          integer(),
          ExWorldCheck.Model.CaseDetailsCollection.t(),
          keyword()
        ) ::
          {:ok, [ExWorldCheck.Model.CaseReferenceDetails.t()]}
          | {:ok, nil}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def save_and_screen_cases(
        connection,
        authorization,
        date,
        content_type,
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, ExWorldCheck.Model.CaseReferenceDetails},
      {400, ExWorldCheck.Model.Error},
      {401, false},
      {403, ExWorldCheck.Model.Error},
      {404, ExWorldCheck.Model.Error},
  ...
  @spec screen(
          ...
          String.t(),
          integer(),
          ExWorldCheck.Model.ScreeningRequest.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.ScreeningResultCollection.t()}
  ...
  - `{:ok, ExWorldCheck.Model.CaseScreeningResultCollection.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec screen_case(Tesla.Env.client(), String.t(), String.t(), String.t(), keyword()) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.CaseScreeningResultCollection.t()}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def screen_case(connection, authorization, date, case_system_id, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, ExWorldCheck.Model.CaseScreeningResultCollection},
      {201, false},
      {400, ExWorldCheck.Model.Error},
      {401, false},
      {403, ExWorldCheck.Model.Error},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec screening_status(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          integer(),
          ExWorldCheck.Model.ScreeningStatusRequestCollection.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, [ExWorldCheck.Model.ScreeningStatusResponse.t()]}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def screening_status(
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, ExWorldCheck.Model.ScreeningStatusResponse},
      {400, ExWorldCheck.Model.Error},
      {401, false},
      {404, ExWorldCheck.Model.Error},
      {415, false},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec scroll_case_summaries(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          integer(),
          ExWorldCheck.Model.Cursor.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.CaseSearchResultResponse.t()}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec toggle_ongoing_screening_by_provider_types(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          integer(),
          ExWorldCheck.Model.CaseBulkOngoingScreeningRequest.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.CaseBulkResponse.t()}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def toggle_ongoing_screening_by_provider_types(
        connection,
        authorization,
        date,
        content_type,
        content_length,
        case_bulk_ongoing_screening_request,
        _opts \\ []
      ) do
    request =
      %{}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec unarchive(Tesla.Env.client(), String.t(), String.t(), String.t(), keyword()) ::
          {:ok, nil} | {:ok, [ExWorldCheck.Model.Error.t()]} | {:error, Tesla.Env.t()}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec unassign_case(Tesla.Env.client(), String.t(), String.t(), String.t(), keyword()) ::
          {:ok, nil} | {:ok, [ExWorldCheck.Model.Error.t()]} | {:error, Tesla.Env.t()}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec update_cases_owner(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          integer(),
          ExWorldCheck.Model.CaseBulkMoveRequest.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.CaseBulkResponse.t()}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def update_cases_owner(
        connection,
        authorization,
        date,
        content_type,
        content_length,
        case_bulk_move_request,
        _opts \\ []
      ) do
    request =
      %{}
