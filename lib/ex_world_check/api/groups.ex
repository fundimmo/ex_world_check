...
defmodule ExWorldCheck.Api.Groups do
  @moduledoc """
  ...
  - `{:ok, ExWorldCheck.Model.CaseTemplateResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_case_template_for_group(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.CaseTemplateResponse.t()}
  ...
  def get_case_template_for_group(connection, authorization, date, group_id, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, ExWorldCheck.Model.CaseTemplateResponse},
  ...
  - `{:ok, ExWorldCheck.Model.Group.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_group_by_id(Tesla.Env.client(), String.t(), String.t(), String.t(), keyword()) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.Group.t()}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_groups(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, nil}
          | {:ok, [ExWorldCheck.Model.Group.t()]}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  ...
  - `{:ok, ExWorldCheck.Model.ResolutionToolkitResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_resolution_toolkit_for_group(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.ResolutionToolkitResponse.t()}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def get_resolution_toolkit_for_group(connection, authorization, date, group_id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, ExWorldCheck.Model.ResolutionToolkitResponse},
      {400, ExWorldCheck.Model.Error},
      {401, false},
      {404, ExWorldCheck.Model.Error},
      {415, false},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_resolution_toolkit_for_group_with_provider_type(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def get_resolution_toolkit_for_group_with_provider_type(
        connection,
        authorization,
        date,
        group_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_resolution_toolkits_for_group(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          {:ok, nil}
          | {:ok, %{optional(String.t()) => ExWorldCheck.Model.ResolutionToolkitResponse.t()}}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
