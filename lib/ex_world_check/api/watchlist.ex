...
defmodule ExWorldCheck.Api.Watchlist do
  @moduledoc """
  ...
  """
  @spec create_or_update_provider_source(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          integer(),
          String.t(),
          ExWorldCheck.Model.ProviderSource.t(),
          keyword()
        ) :: {:ok, nil} | {:ok, [ExWorldCheck.Model.Error.t()]} | {:error, Tesla.Env.t()}
  def create_or_update_provider_source(
        connection,
        authorization,
        date,
        content_type,
  ...
  - `{:ok, ExWorldCheck.Model.WatchlistResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec save_watchlist(
          Tesla.Env.client(),
          ...
          String.t(),
          integer(),
          ExWorldCheck.Model.WatchlistDataSet.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.WatchlistResponse.t()}
  ...
  def save_watchlist(
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {201, ExWorldCheck.Model.WatchlistResponse},
      {400, ExWorldCheck.Model.Error},
      {401, false},
      {404, ExWorldCheck.Model.Error},
      {415, false},
