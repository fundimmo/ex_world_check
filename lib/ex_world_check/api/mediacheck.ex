...
defmodule ExWorldCheck.Api.Mediacheck do
  @moduledoc """
  ...
  - `{:ok, ExWorldCheck.Model.ResultsMediaCheckResolutionResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec attach_articles(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          integer(),
          String.t(),
          ExWorldCheck.Model.ResultsMediaCheckResolutionRequest.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.ResultsMediaCheckResolutionResponse.t()}
  ...
  def attach_articles(
    ...
    |> evaluate_response([
      {200, ExWorldCheck.Model.ResultsMediaCheckResolutionResponse},
  ...
  @spec detach_articles(
          ...
          integer(),
          String.t(),
          ExWorldCheck.Model.MediaCheckDetachArticlesRequest.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.ResultsMediaCheckResolutionResponse.t()}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec disable_smart_filter_on_case(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec enable_smart_filter_on_case(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
  ...
  - `{:ok, ExWorldCheck.Model.MediaCheckArticlesMetadataResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_media_check_articles_metadata(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          integer(),
          String.t(),
          ExWorldCheck.Model.MediaCheckArticlesMetadataRequest.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.MediaCheckArticlesMetadataResponse.t()}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def get_media_check_articles_metadata(
        connection,
        authorization,
        date,
        content_type,
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, ExWorldCheck.Model.MediaCheckArticlesMetadataResponse},
      {400, ExWorldCheck.Model.Error},
      {401, false},
      {404, ExWorldCheck.Model.Error},
      {415, false},
  ...
  - `{:ok, ExWorldCheck.Model.MediaCheckResultsResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_media_check_details(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          integer(),
          String.t(),
          ExWorldCheck.Model.MediaCheckResultsRequest.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.MediaCheckResultsResponse.t()}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def get_media_check_details(
        connection,
        authorization,
        date,
        content_type,
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, ExWorldCheck.Model.MediaCheckResultsResponse},
      {400, ExWorldCheck.Model.Error},
      {401, false},
      {404, ExWorldCheck.Model.Error},
      {415, false},
  ...
  - `{:ok, ExWorldCheck.Model.MediaCheckResultsContentResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_media_check_results_content(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          integer(),
          String.t(),
          ExWorldCheck.Model.MediaCheckContentRequest.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.MediaCheckResultsContentResponse.t()}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def get_media_check_results_content(
        connection,
        authorization,
        date,
        content_type,
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, ExWorldCheck.Model.MediaCheckResultsContentResponse},
      {400, ExWorldCheck.Model.Error},
      {401, false},
      {404, ExWorldCheck.Model.Error},
      {415, false},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_media_check_risks(Tesla.Env.client(), String.t(), String.t(), keyword()) ::
          {:ok, nil}
          | {:ok, [String.t()]}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_media_check_single_article_metadata(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def get_media_check_single_article_metadata(
        connection,
        authorization,
        date,
        case_system_id,
  ...
  - `{:ok, ExWorldCheck.Model.SmartFilterResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_media_check_smart_filter(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          {:ok, ExWorldCheck.Model.SmartFilterResponse.t()}
          | {:ok, nil}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def get_media_check_smart_filter(connection, authorization, date, case_system_id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, ExWorldCheck.Model.SmartFilterResponse},
      {400, ExWorldCheck.Model.Error},
      {401, false},
      {404, ExWorldCheck.Model.Error},
      {415, false},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_single_article_media_check_content(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def get_single_article_media_check_content(
        connection,
        authorization,
        date,
        case_system_id,
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec retrieve_articles(Tesla.Env.client(), String.t(), String.t(), String.t(), keyword()) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.MediaCheckArticlesMetadataResponse.t()}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec retrieve_media_check_duplicates(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          integer(),
          String.t(),
          ExWorldCheck.Model.MediaCheckDuplicatesRequest.t(),
          keyword()
        ) ::
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.MediaCheckArticlesMetadataResponse.t()}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def retrieve_media_check_duplicates(
        connection,
        authorization,
        date,
        content_type,
  ...
  - `{:ok, ExWorldCheck.Model.ArticlesReviewDate.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec update_articles_reviewed_date(
          Tesla.Env.client(),
          String.t(),
          String.t(),
          String.t(),
          ...
          {:ok, nil}
          | {:ok, ExWorldCheck.Model.ArticlesReviewDate.t()}
          | {:ok, [ExWorldCheck.Model.Error.t()]}
          | {:error, Tesla.Env.t()}
  def update_articles_reviewed_date(connection, authorization, date, case_system_id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, ExWorldCheck.Model.ArticlesReviewDate},
      {400, ExWorldCheck.Model.Error},
      {401, false},
      {404, ExWorldCheck.Model.Error},
      {415, false},
