...
defmodule ExWorldCheck.Connection do
  ...
  - `options`: a keyword list of ExWorldCheck.Connection.options.
  ...
  def middleware(options \\ []) do
    base_url =
      Keyword.get(
        options,
        :base_url,
        Application.get_env(:ex_world_check, :base_url, @default_base_url)
      )
    ...
    user_agent =
      Keyword.get(
        ...
        Keyword.get(
          tesla_options,
          :user_agent,
          "openapi-generator - ExWorldCheck 0.2.0 - elixir"
        )
      )
